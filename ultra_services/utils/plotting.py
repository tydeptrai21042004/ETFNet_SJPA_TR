...
class Colors:
    ...
    def __init__(self):
        ...
        hexs = ('FF3838', '00FF00', '0000FF', 'FFB21D', 'CFD231', '48F90A', '92CC17', '3DDB86', '1A9334', '00D4BB',
                '2C99A8', '00C2FF', '344593', '6473FF', '0018EC', '8438FF', '520085', 'CB38FF', 'FF95C8', 'FF37C7')
...
def plot_labels(boxes, cls, names=(), save_dir=Path(''), on_plot=None):
    ...
    # Seaborn correlogram
    sn.pairplot(x, corner=True, diag_kind='auto', kind='hist', diag_kws=dict(bins=50, color='tab:blue'), plot_kws=dict(pmax=0.9, color='tab:blue'))
...
def plot_images(images,
    ...
    # RGB--IR models carry six channels in canonical order [RGB, IR].
    # Plot only the RGB view so diagnostics remain compatible with standard 3-channel canvases.
            ...
            if len(bboxes):
                ...
                for j, box in enumerate(boxes.astype(np.int64).tolist()):
                    ...
                    if labels or conf[j] > 0.25:  # 0.25 conf thresh
                        ...
                        #label = None
                        label = None if labels else f'{conf[j]:.1f}'
